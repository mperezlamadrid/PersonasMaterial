...
public class EditarPersona extends AppCompatActivity {
    ...
    public void editar(View v){
        if (validarE()){
            ...
            p.editar();
            Snackbar.make(v, res.getString(R.string.persona_editada_correctamente), Snackbar.LENGTH_LONG)
    ...
    public boolean validarE(){
        ...
        else if (Metodos.existenciaPersonaEditar(Datos.obtenerPersonas(),txtCedulaE.getText().toString(),cedula)) {
